...
def add_arguments(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument('-dt', type=float, default=0.5*6, help='Time interval per decision')
    ...
    parser.add_argument('-algorithmfloats', nargs=8, type=float, default=[0.9, 1e-4, 1e-3, 1e-0, 1e-0, 0.3, 0.001, 0.0],
    ...
    parser.add_argument('-algorithmints', nargs=10, type=int,
                        ...
                        default=[1000, 4, 3, 301, 150/6, 300000, 128, 32, 4, 10000],
    ...
    parser.add_argument('-mlp', nargs=3, default=[1, [32], 'relu'],
                        help='Multi layer perceptron with: n_hiddens n_neurons activation')
