...
def add_arguments(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    parser.add_argument('-paramspath', type=str)
    return parser
    ...
    # parser.add_argument('-algorithmfloats', nargs=8, type=float, default=[0.9, 1e-4, 1e-2, 1e-0, 1e-0, 0.3, 0.001, 0.0],
    ...
    #                     default=[1000, 4, 3, 21, 20, 300000, 128, 32, 4, 10000],
