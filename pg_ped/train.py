...
def start_training(episodes, parameter_dict, losses, reward_sums, episode_lengths, number_episodes, number_agents,
                   model_name, model_path, curves_path, optimizer_message_frequency, plot=True, use_traci=False, ports=None):
    ...
    if plot is True:# Visualize loss and reward
        plot_loss_and_reward_curves(curves_path, number_episodes, losses, reward_sums, number_agents, model_name)
